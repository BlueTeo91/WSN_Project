...
{ 
  ...
  Uart1_SetBaud(((UartBaudRate_t) 19200));
...
static void UartRxCallBack(void) 
{
  uint8_t pressedKey;
    ...
    TS_SendEvent(gAppTaskID_c, (1 << 1));
	  ...
	  (void)Uart1_GetByteFromRxBuffer(&pressedKey);
  }
}
...
static uint8_t App_StartScan(uint8_t scanType)
{
  ...
  if(pMsg != (( void * )( 0 )))
  {
    ...
    pScanReq->scanChannels[0] = (uint8_t)((0x07FFF800)     & 0xFF);
     
    pScanReq->scanChannels[1] = (uint8_t)((0x07FFF800>>8)  & 0xFF);
     
    pScanReq->scanChannels[2] = (uint8_t)((0x07FFF800>>16) & 0xFF);
     
    pScanReq->scanChannels[3] = (uint8_t)((0x07FFF800>>24) & 0xFF);
...
static uint8_t App_SetParam(uint8_t attribute, bool_t *pValue)
{
  ...
  return ((NWK_MLME_SapHandler)((void *)(&mlmeSet)));
...
static uint8_t App_GetParam(uint8_t attribute, bool_t* pValue)
{
  ...
  return ((NWK_MLME_SapHandler)((void *)(&mlmeGet)));
}
