...
)
{
  ...
  mSwTaskID = TS_CreateTask(0x1F, KBD_Task);
  
   
  TMR_StartIntervalTimer(mKeyScanTimerID, 50, KeyScan);  
...
void CrmKBDIsr(void)
{
  ...
  ((crmWuCntlReg_t*)&((CrmRegs_t *)0x80003000)->WuCntl)->bit . extWuIEn &= ~(1 << (gGpioPin26_c - gGpioPin26_c) | 1 << (gGpioPin27_c - gGpioPin26_c) | 1 << (gGpioPin28_c - gGpioPin26_c) | 1 << (gGpioPin29_c - gGpioPin26_c));
  TS_SendEvent(mSwTaskID, 0x01);
...
void KBD_EnableDisableKeyScan(bool_t enable)
{
 ...
 {  
  ...
  {
    if(((crmWuCntlReg_t*)&((CrmRegs_t *)0x80003000)->WuCntl)->bit .extWuIEn  == (1 << (gGpioPin26_c - gGpioPin26_c) | 1 << (gGpioPin27_c - gGpioPin26_c) | 1 << (gGpioPin28_c - gGpioPin26_c) | 1 << (gGpioPin29_c - gGpioPin26_c)))
    {
...
{
  return (uint8_t)((KbReadPins() & 1 << (gGpioPin26_c - gGpioPin26_c)) ^ 1 << (gGpioPin26_c - gGpioPin26_c)) | ((KbReadPins() & 1 << (gGpioPin27_c - gGpioPin26_c)) ^ 1 << (gGpioPin27_c - gGpioPin26_c)) | ((KbReadPins() & 1 << (gGpioPin28_c - gGpioPin26_c)) ^ 1 << (gGpioPin28_c - gGpioPin26_c)) | ((KbReadPins() & 1 << (gGpioPin29_c - gGpioPin26_c)) ^ 1 << (gGpioPin29_c - gGpioPin26_c));
}
...
)
{
  ...
  static uint8_t markLongPress = 0;
   
  centerKeyDetect = 0xFF; 
  if( 0 == KbReadCenterKey() ) 
  {
     
    if(mLongCenterKeyCount > 20) 
    {   
  ...
  case mStateKeyDetected:
    ...
    if(keyBase) {
      ...
      if(mSwitch_SCAN & 1 << (gGpioPin26_c - gGpioPin26_c))
      {
        mKeysStillPressed |= mSwitch_SCAN;
        mpfKeyFunction(keyBase + 0);
      }
      if(mSwitch_SCAN & 1 << (gGpioPin27_c - gGpioPin26_c))
      {
        mKeysStillPressed |= mSwitch_SCAN;
        mpfKeyFunction(keyBase + 1);
      }
      if(mSwitch_SCAN & 1 << (gGpioPin28_c - gGpioPin26_c))
      {
        mKeysStillPressed |= mSwitch_SCAN;
        mpfKeyFunction(keyBase + 2);
      }
      if(mSwitch_SCAN & 1 << (gGpioPin29_c - gGpioPin26_c))
      {
        mKeysStillPressed |= mSwitch_SCAN;
