...
@param  bool_t   UartDirectFifoMode  - input parameter: FALSE - the function waits for specified number of bytes; TRUE - the driver exposes the HW FIFO to the user
