...
static const uint8_t maShortAddress[2] = { (0x19 & 0xff), (0x19 >> 8)};
static const uint8_t maPanId[2] = { (0x05 & 0xff), (0x05 >> 8)};
...
void AppTask(event_t events)
{
  ...
  case stateInit:    
    ...
    UartUtil_Print("MyWirelessApp Demo Non Beacon Coordinator application is initialized and ready.\n\r\n\r", gAllowToBlock_d);            
...
{  
  ...
  {
    ChannelMask = n + 11;
	if((pEdList[n] < minEnergy)&&((uint8_t)((0x8000>>ChannelMask) & 0x1)))
    {
      minEnergy = pEdList[n];
  ...
  { MM_Free(pEdList); (pEdList) = (( void * )( 0 )); };
}
...
static uint8_t App_StartCoordinator(void)
{
  ...
  if(pMsg != (( void * )( 0 )))
  {
    ...
    (void) ((NWK_MLME_SapHandler)((void *)(pMsg)));
...
static uint8_t App_SendAssociateResponse(nwkMessage_t *pMsgIn)
{
  ...
  if(pMsg != (( void * )( 0 )))
  {
    ...
    pAssocRes->status = 0x00;
     
    pAssocRes->securityEnable = 0;
...
static uint8_t App_HandleMlmeInput(nwkMessage_t *pMsg)
{
  ...
  case gNwkCommStatusInd_c:
    ...
    UartUtil_Print("Received an MLME-Comm-Status Indication from the MAC\n\r", gAllowToBlock_d);
    break;
  }
  return errorNoError;
}
...
static void App_HandleMcpsInput(mcpsToNwkMessage_t *pMsgIn)
{
  ...
  case gMcpsDataInd_c:
    ...
    UartUtil_Print("Received the data packet from MCPS\n\r", gAllowToBlock_d);
