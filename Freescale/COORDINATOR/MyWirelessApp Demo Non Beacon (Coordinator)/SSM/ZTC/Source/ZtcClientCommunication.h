...
/* Expected value of an mUARTStx_t. */
#define mUartStxValue_c     ((unsigned char) 0x02)
...
/* A complete UART packet is a UART envelope + a variable length */
/* clientPacket_t. */
/* A UART envelope is a leading mUARTStx_t and a trailing mUARTFcs_t. */
typedef uint8_t mUartStx_t;             /* A sync octet. */
