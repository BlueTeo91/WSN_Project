...
ZdoApsmeTbl(0xCF, 0xCF,        gZtcMsgFlagAsync_c,   sizeof(apsmeEstablishKeyReq_t),                gZtcMsgFmtSimple_c             ) /* APSME-ESTABLISH-KEY.Request     */
ZdoApsmeTbl(0xD0, gUnused_c,   gZtcMsgFlagAsync_c,   sizeof(apsmeEstablishKeyRes_t),                gZtcMsgFmtSimple_c             ) /* APSME-ESTABLISH-KEY.response    */
ZdoApsmeTbl(0xD1, 0xD1,        gZtcMsgFlagAsync_c,   sizeof(zbApsmeTransportKeyReq_t),              gZtcMsgFmtSimple_c             ) /* APSME-TRANSPORT-KEY.Request     */
ZdoApsmeTbl(0xD3, 0xD3,        gZtcMsgFlagAsync_c,   sizeof(apsmeRequestKeyReq_t),                  gZtcMsgFmtSimple_c             ) /* APSME-REQUEST-KEY.Request       */
ZdoApsmeTbl(0xD4, 0xD4,        gZtcMsgFlagAsync_c,   sizeof(zbApsmeSwitchKeyReq_t),                 gZtcMsgFmtSimple_c             ) /* APSME-SWITCH-KEY.Request        */
...
ZdoApsmeTbl(0xF3, 0xF3,        gZtcMsgFlagAsync_c,   sizeof(zbApsmeUpdateDeviceReq_t),              gZtcMsgFmtSimple_c             ) /* APSME-UPDATE-DEVICE.Request     */
ZdoApsmeTbl(0xF4, 0xF4,        gZtcMsgFlagAsync_c,   sizeof(zbApsmeRemoveDeviceReq_t),              gZtcMsgFmtSimple_c             ) /* APSME-REMOVE-DEVICE.Request     */
#undef ZdoApsmeTbl
#endif
...
#endif
ApsmeZdoTbl(0xD6, gUnused_c,   gZtcMsgFlagAsync_c,   sizeof(apsmeEstablishKeyInd_t),                gZtcMsgFmtSimple_c             ) /* APSME-ESTABLISH-KEY.Indication   */
ApsmeZdoTbl(0xD8, gUnused_c,   gZtcMsgFlagAsync_c,   sizeof(apsmeRemoveDeviceInd_t),                gZtcMsgFmtSimple_c             ) /* APSME-REMOVE-DEVICE.Indication   */
ApsmeZdoTbl(0xD9, gUnused_c,   gZtcMsgFlagAsync_c,   sizeof(apsmeRequestKeyInd_t),                  gZtcMsgFmtSimple_c             ) /* APSME-REQUEST-KEY.Indication     */
ApsmeZdoTbl(0xF1, gUnused_c,   gZtcMsgFlagAsync_c,   sizeof(apsmeSwitchKeyInd_t),                   gZtcMsgFmtSimple_c             ) /* APSME-SWITCH-KEY.Indication      */
ApsmeZdoTbl(0xF2, gUnused_c,   gZtcMsgFlagAsync_c,   sizeof(apsmeTransportKeyInd_t),                gZtcMsgFmtSimple_c             ) /* APSME-TRANSPORT-KEY.Indication   */
ApsmeZdoTbl(0xD7, gUnused_c,   gZtcMsgFlagAsync_c,   sizeof(apsmeUpdateDeviceInd_t),                gZtcMsgFmtSimple_c             ) /* APSME-UPDATE-DEVICE.Indication   */
ApsmeZdoTbl(0x0B, 0x0B,        gZtcMsgFlagAsync_c,   gZero_c,                                       gZtcMsgFmtSimple_c             ) /* APSME-RESET.Confirm              */
ApsmeZdoTbl(0xCF, gUnused_c,   gZtcMsgFlagAsync_c,   sizeof(apsmeEstablishKeyCnf_t),                gZtcMsgFmtSimple_c             ) /* APSME-ESTABLISH-KEY.Confirm      */
ApsmeZdoTbl(0xD1, 0xD1,        gZtcMsgFlagAsync_c,   sizeof(apsmeTransportKeyCnf_t),                gZtcMsgFmtSimple_c             ) /* APSME-TRANSPORT-KEY.Confirm      */
ApsmeZdoTbl(0xD3, 0xD3,        gZtcMsgFlagAsync_c,   sizeof(apsmeRequestKeyCnf_t),                  gZtcMsgFmtSimple_c             ) /* APSME-REQUEST-KEY.Confirm        */
ApsmeZdoTbl(0xD4, 0xD4,        gZtcMsgFlagAsync_c,   sizeof(apsmeSwitchKeyCnf_t),                   gZtcMsgFmtSimple_c             ) /* APSME-SWITCH-KEY.Confirm         */
ApsmeZdoTbl(0xF3, 0xF3,        gZtcMsgFlagAsync_c,   sizeof(apsmeUpdateDevice_t),                   gZtcMsgFmtSimple_c             ) /* APSME-UPDATE-DEVICE.Confirm      */
ApsmeZdoTbl(0xF4, 0xF4,        gZtcMsgFlagAsync_c,   sizeof(apsmeRemoveDevice_t),                   gZtcMsgFmtSimple_c             ) /* APSME-REMOVE-DEVICE.Confirm      */
...
//ZdpAppTbl(0xD0, gUnused_c,   gZtcMsgFlagAsync_c,   ZdpAppSize(zdoApsmeEstKeyResp_t),                gZtcMsgFmtSimple_c             ) /* ZDP-APSME-ESTABLISH-KEY.response      */
//ZdpAppTbl(0xD5, gUnused_c,   gZtcMsgFlagAsync_c,   ZdpAppSize(zdoEstablishKeyConf_t),               gZtcMsgFmtSimple_c             ) /* ZDP-APSME-ESTABLISH-KEY.Confirm       */
//ZdpAppTbl(0xD6, gUnused_c,   gZtcMsgFlagAsync_c,   ZdpAppSize(zdoEstablishKeyInd_t),                gZtcMsgFmtSimple_c             ) /* ZDP-APSME-ESTABLISH-KEY.Indication    */
//ZdpAppTbl(0xD7, gUnused_c,   gZtcMsgFlagAsync_c,   ZdpAppSize(zdoUpdateDeviceInd_t),                gZtcMsgFmtSimple_c             ) /* ZDP-APSME-UPDATE-DEVICE.Indication    */
//ZdpAppTbl(0xD8, gUnused_c,   gZtcMsgFlagAsync_c,   ZdpAppSize(zdoRemoveDeviceInd_t),                gZtcMsgFmtSimple_c             ) /* ZDP-APSME-REMOVE-DEVICE.Indication    */
//ZdpAppTbl(0xD9, gUnused_c,   gZtcMsgFlagAsync_c,   ZdpAppSize(zdoRequestKeyInd_t),                  gZtcMsgFmtSimple_c             ) /* ZDP-APSME-REQUEST-KEY.Indication      */
ZdpAppTbl(0xE6, gUnused_c,   gZtcMsgFlagAsync_c,   ZdpAppSize(zdo2AppEvent_t),                      gZtcMsgFmtSimple_c             ) /* ZDP-SystemEvent.Indication            */
//ZdpAppTbl(0xF1, gUnused_c,   gZtcMsgFlagAsync_c,   ZdpAppSize(zdoSwitchKeyInd_t),                   gZtcMsgFmtSimple_c             ) /* ZDP-APSME-SWITCH-KEY.Indication       */
//ZdpAppTbl(0xF2, gUnused_c,   gZtcMsgFlagAsync_c,   ZdpAppSize(zdoTransportKeyInd_t),                gZtcMsgFmtSimple_c             ) /* ZDP-APSME-TRANSPORT-KEY.Indication    */
...
ZtcMsgTbl(mZtcMsgAPSReadyReq_c,             ZtcMsgAPSReadyReqFunc)              /* ZTC-SetAPSReady.Request.             */
#endif
