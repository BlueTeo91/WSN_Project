...
void Init_802_15_4(bool_t mUseTS)
{
  ...
  
  {
   ...
   reg_value &= (uint32_t)0xFF00FFFF;  
   reg_value |= (uint32_t) gHardwareParameters.ccaThreshold << 16;  
...
static void PlatformInitGpio(void)
{
  ((GpioRegs_t *)0x80000000)->DataLo = 0x03C00000;                  
  ((GpioRegs_t *)0x80000000)->DataHi = 0x00000000;                  

  ((GpioRegs_t *)0x80000000)->DirLo =  0x03C00000;                   
  ((GpioRegs_t *)0x80000000)->DirHi =  0x00000000;                   

  ((GpioRegs_t *)0x80000000)->PuEnLo = 0xFFFFFFFF;                  
  ((GpioRegs_t *)0x80000000)->PuEnHi = 0xFFFFFFFF;                  
  ((GpioRegs_t *)0x80000000)->FuncSel0 = 0x00000000;              
  ((GpioRegs_t *)0x80000000)->FuncSel1 = 0x00000000;              
  ((GpioRegs_t *)0x80000000)->FuncSel2 = 0x00000000;              
  ((GpioRegs_t *)0x80000000)->FuncSel3 = 0x00000000;              
  ((GpioRegs_t *)0x80000000)->InputDataSelLo = 0x00000000;  
  ((GpioRegs_t *)0x80000000)->InputDataSelHi = 0x00000000;  
  ((GpioRegs_t *)0x80000000)->PuSelLo = 0x00003000;                
  ((GpioRegs_t *)0x80000000)->PuSelHi = 0x8001C000;                
  ((GpioRegs_t *)0x80000000)->HystEnLo = 0x00000000;              
  ((GpioRegs_t *)0x80000000)->HystEnHi = 0x00000000;              
  ((GpioRegs_t *)0x80000000)->PuKeepLo = 0xC0000000;              
  ((GpioRegs_t *)0x80000000)->PuKeepHi = 0x000000DF;              
}
