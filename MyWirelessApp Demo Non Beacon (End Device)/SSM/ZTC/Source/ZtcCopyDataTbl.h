...
FmtTwoArrayPtrs(mFmtZdpMatchDescReq_c,                                                              /* name             */ \
                (AppZdpSize(zbMatchDescriptorRequest_t)),                                           /* hdrLen           */ \
                (AppZdpOfs( zbMatchDescriptorRequest_t, inputClusterList.pClusterList)),            /* offsetToPtr1     */ \
                (AppZdpOfs( zbMatchDescriptorRequest_t, inputClusterList.cNumClusters)),            /* offsetToCount1   */ \
                (IndirectMbrSizeof(zbMatchDescriptorRequest_t, inputClusterList.pClusterList)),     /* array1ElementLen */ \
                (AppZdpSize(zbMatchDescriptorRequest_t)),                                           /* offsetToMsgData  */ \
                (AppZdpOfs( zbMatchDescriptorRequest_t, outputClusterList.pClusterList)),           /* offsetToPtr2     */ \
                (AppZdpOfs( zbMatchDescriptorRequest_t, outputClusterList.cNumClusters)),           /* offsetToCount2   */ \
                (IndirectMbrSizeof(zbMatchDescriptorRequest_t, outputClusterList.pClusterList)))    /* array2ElementLen */
